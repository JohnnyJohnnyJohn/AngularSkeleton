...
export class HeaderComponent implements AfterViewInit{
  ...
  ngAfterViewInit() {
      this.darkModeSwitch.nativeElement.querySelector('.mdc-switch__icon--on').firstChild.setAttribute('d', this.moon);
      this.darkModeSwitch.nativeElement.querySelector('.mdc-switch__icon--off').firstChild.setAttribute('d', this.sun);
  }
